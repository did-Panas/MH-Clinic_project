    ...
    (() => {
        ...
        let formValidate = {
            ...
            addError(formRequiredItem) {
                ...
                if (formRequiredItem.dataset.error) formRequiredItem.parentElement.insertAdjacentHTML("beforeend", `<div role="alert" class="form__error">${formRequiredItem.dataset.error}</div>`);
            },
        ...
        if (document.querySelector("[data-datepicker]")) {
            const picker = datepicker_min("[data-datepicker]", {
                ...
                customOverlayMonths: [ "Jan", "Feb", "Mar", "Apr", "May", "Jun", "Jul", "Aug", "Sep", "Oct", "Nov", "Dec" ],
            ...
            function updateLeftArrowState(instance) {
                ...
                if (instance.currentMonth !== void 0 && instance.currentYear !== void 0) {
                ...
                if (currentYear === todayYear && currentMonth <= todayMonth || currentYear < todayYear) leftArrow.classList.add("disabled"); else leftArrow.classList.remove("disabled");
            ...
            document.addEventListener("click", (function(e) {
                if (e.target.classList.contains("qs-arrow") && e.target.classList.contains("qs-left") && e.target.classList.contains("disabled")) {
                    e.preventDefault();
                    e.stopPropagation();
                    return false;
                }
        ...
        function initSliders() {
            if (document.querySelector(".slider-exp__slider")) new swiper_core_Swiper(".slider-exp__slider", {
                modules: [ Navigation ],
                observer: true,
                observeParents: true,
                speed: 800,
                loop: true,
                navigation: {
                    prevEl: ".slider-exp__btn-prev",
                    nextEl: ".slider-exp__btn-next"
                },
                breakpoints: {
                    550: {
                        slidesPerView: 2,
            ...
            if (document.querySelector(".slider-blogs__slider")) new swiper_core_Swiper(".slider-blogs__slider", {
                modules: [ Navigation ],
                observer: true,
                observeParents: true,
                slidesPerView: 1,
        ...
        function animatedCounters() {
            ...
            function formatNumber(value, format) {
                if (format === ",") return value.toString().replace(/\B(?=(\d{3})+(?!\d))/g, ",");
            ...
            function initAndAnimateCounters(container) {
                ...
                if (animationPromises.length > 0) Promise.all(animationPromises).then((() => {
            ...
            function handleWatcherCallback(e) {
                ...
                if (e.detail.entry.isIntersecting) initAndAnimateCounters(targetElement);
            }
        ...
        if (timeInput) timeInput.addEventListener("focus", (function(e) {
        ...
        function initStepForm() {
            ...
            prevBtn.addEventListener("click", (() => {
                if (formStepIndex < stepIndicators.length) stepIndicators[formStepIndex].classList.remove("complete");
                if (formStepIndex > 0 && formStepIndex - 1 < progressLines.length) progressLines[formStepIndex - 1].classList.remove("animate");
                formStepIndex--;
                updateFormSteps();
            }));
            nextBtn.addEventListener("click", (() => {
                if (formStepIndex < steps.length - 1) if (steps[formStepIndex].classList.contains("date-step")) if (inputDate.value.length > 0 && inputTime.value.length > 0) {
                ...
                } else makeNextStep(); else if (formStepIndex === steps.length - 1 && inputPhone.value.length > 0) {
                    if (formStepIndex < stepIndicators.length) stepIndicators[formStepIndex].classList.add("complete");
                    finishBlock.style.display = "grid";
                    if (steps[formStepIndex]) steps[formStepIndex].classList.remove("active");
            ...
            function updateFormSteps() {
                ...
                if (steps[formStepIndex]) steps[formStepIndex].classList.add("active");
                if (formStepIndex === 0) prevBtn.style.display = "none"; else prevBtn.style.display = "block";
                if (formStepIndex === steps.length - 1) nextBtn.innerHTML = "Submit"; else nextBtn.innerHTML = "Next";
            }
            function makeNextStep() {
                if (formStepIndex < stepIndicators.length) stepIndicators[formStepIndex].classList.add("complete");
                if (formStepIndex < progressLines.length) progressLines[formStepIndex].classList.add("animate");
                formStepIndex++;
                updateFormSteps();
            }
            updateFormSteps();
